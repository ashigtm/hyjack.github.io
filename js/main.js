(function ($, window, undefined) {
  ...
  function platformDetect() {
    ...
    var isiPhone = navPlat.indexOf("iphone"),
      ...
      svgSupportAlt = document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1")
        ? true
        : false,
      ...
      $(this.selector).each(function (i, header) {
        ...
        if ($title.length && $title.text().trim().length) {
          timeline.fromTo(
            ...
            { "letter-spacing": "0.2em", "margin-right": "-0.1em", ease: Expo.easeOut }
          );
  ...
  var DownArrow = {
    ...
    initialize: function () {
      ...
      if (this.$arrow.hasClass("down-arrow--bubble")) {
        this.timeline.to(this.$arrow, 0.2, { y: 10, opacity: 0, ease: Linear.easeNone, overwrite: "none" });
        this.timeline.to(".blurp--top", 0.3, { scaleY: 0, ease: Linear.easeNone, overwrite: "none" });
        this.bubble = true;
      } else {
  ...
  PrBufNode.prototype.findLatestIncompleteNode = function () {
    ...
    if ((this.val.type === "m" && this.val.value > this.getTotalDescendantCount()) || null === this.parent) {
      return this;
    } else {
              ...
              for (var i = 0; i < wptNodes.length; i++) {
                ...
                if (wptNode.id() == 2) {
                  ...
                  if (
                    ...
                    this.route.pushWaypoint(new GmdpWaypoint(coordNodes[1].value(), coordNodes[0].value(), true));
                  }
                  ...
                  if (secondaryWpts && secondaryWpts.length > 1) {
                    ...
                    if (
                      ...
                      this.route.pushWaypoint(new GmdpWaypoint(coordNodes[1].value(), coordNodes[0].value(), false));
                    }
                  }
                }
              }
  ...
  GMap.prototype.customStyle = [
    {
      stylers: [{ saturation: -100 }, { gamma: 3.0 }, { visibility: "simplified" }],
    },
    {
      featureType: "road",
      stylers: [
  ...
  function sliderInit($slider) {
    ...
    var $children = $(this).children(),
      ...
      rs_slidesSpacing =
        typeof $slider.data("slidesspacing") !== "undefined" ? parseInt($slider.data("slidesspacing")) : 0,
      rs_keyboardNav = typeof $slider.data("fullscreen") !== "undefined",
      rs_imageScale = $slider.data("imagescale"),
      rs_visibleNearby = typeof $slider.data("visiblenearby") !== "undefined",
      rs_imageAlignCenter = typeof $slider.data("imagealigncenter") !== "undefined",
      rs_transition =
        typeof $slider.data("slidertransition") !== "undefined" && $slider.data("slidertransition") !== ""
          ? $slider.data("slidertransition")
          : "move",
      rs_autoPlay = typeof $slider.data("sliderautoplay") !== "undefined",
      rs_delay =
        typeof $slider.data("sliderdelay") !== "undefined" && $slider.data("sliderdelay") !== ""
